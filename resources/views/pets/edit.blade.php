      ...
      <form action="{{ route('pets.update', $pet) }}" method="post">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="col-md-12">
              <h5>Editar Mascota Para Propiedad: {{ $property->name }} - {{ $property->tower->name }}</h5>
              ...
              <div class="row">
                ...
                <div class="mt-2 ml-1 mb-3 col-md-12 row">
                  <div class="col-md-3">
                    ...
                    <input class="form-control form-control-sm" type="text" id="name" name="name" value="{{ old('name', $pet->name) }}"></input>
                  </div>
                  <div class="col-md-3">
                    ...
                    @if($animals!= null)
                      <select id="animal_id" class="form-control form-control-sm" name="animal_id">
                        ...
                        @foreach($animals as $animal)
                          @if($animal->id == old('animal_id', $pet->animal_id))
                  ...
                  <div class="col-md-3">
                    ...
                    <input class="form-control form-control-sm" type="text" id="what_type" name="what_type" value="{{ old('what_type', $pet->what_type) }}"></input>
                  </div>
                  <div class="col-md-3">
                    <label for="breed" class="form-control-sm">Raza:</label>
                    <input class="form-control form-control-sm" type="text" id="breed" name="breed" value="{{ old('breed', $pet->breed) }}"></input>
                  </div>
                </div>
              </div>
            </div>
